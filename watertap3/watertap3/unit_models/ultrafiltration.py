...
def cost_ultrafiltration(blk):
    ...
    blk.capital_cost_base = Var(
        ...
        doc="Ultrafiltration capital cost equation slope",
    )
...
@declare_process_block_class("Ultrafiltration")
class UnitProcessData(WT3UnitProcessSIDOData):
    def build(self):
        ...
        self.operating_pressure = Param(
            ...
            mutable=True,
            units=pyunits.bar,
            doc="Ultrafiltration operating pressure",
        )
        ...
        self.pump_efficiency = Param(
            ...
            doc="Ultrafiltration pump efficiency",
        )

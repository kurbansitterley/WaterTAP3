...
def cost_microfiltration(blk):
    ...
    blk.capital_cost_base = Var(
        ...
        doc="Microfiltration capital cost equation slope",
    )
...
@declare_process_block_class("Microfiltration")
class UnitProcessData(WT3UnitProcessSIDOData):
    def build(self):
        ...
        self.operating_pressure = Param(
            ...
            mutable=True,
            units=pyunits.bar,
            doc="Microfiltration operating pressure",
        )
        ...
        self.pump_efficiency = Param(
            ...
            doc="Microfiltration pump efficiency",
        )
